...
import examples.streaming.join.bean.Element;
import examples.streaming.join.source.StreamDataSource1;
import examples.streaming.join.source.StreamDataSource2;
import examples.streaming.join.util.JoinUtil;

import java.util.HashMap;
import java.util.HashSet;

import static examples.streaming.join.util.JoinUtil.getEnv;
