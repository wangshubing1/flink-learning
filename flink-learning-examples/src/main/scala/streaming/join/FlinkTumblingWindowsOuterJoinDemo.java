...
import streaming.join.bean.Element;
import streaming.join.source.StreamDataSource1;
import streaming.join.source.StreamDataSource2;
import streaming.join.util.JoinUtil;

import java.util.HashMap;
import java.util.HashSet;

import static streaming.join.util.JoinUtil.getEnv;
