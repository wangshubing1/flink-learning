...
public class KuduConnector implements AutoCloseable {
    ...
    public KuduConnector(String kuduMasters, KuduTableInfo tableInfo) throws IOException {
        this(kuduMasters, tableInfo, KuduConnector.Consistency.STRONG, KuduConnector.WriteMode.UPSERT, SessionConfiguration.FlushMode.AUTO_FLUSH_SYNC);
    }

    public KuduConnector(String kuduMasters, KuduTableInfo tableInfo, Consistency consistency, WriteMode writeMode, SessionConfiguration.FlushMode flushMode) throws IOException {
